    ...
    <aside className="w-64 min-h-screen bg-gray-900 text-gray-100 flex flex-col">
      <div className="px-6 py-5 border-b border-gray-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-semibold text-sm leading-tight">PA System</p>
      ...
      <div className="px-3 py-4 border-t border-gray-700">
        <p className="text-xs text-gray-500 text-center">ESP32 PA System v1.0</p>
      </div>
    </aside>
  )
}
